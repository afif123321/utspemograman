...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recycle = findViewById(R.id.rcycler_view)
        listData = ArrayList()
        ...
        listData.add(StringData("Kevin De Bruyne", "180441100007", "31 Tahun", R.drawable.foto3))
        listData.add(StringData("Sergio Kun Aguer", "160441100043", "34 tahun", R.drawable.foto12))
        listData.add(StringData("Alvaro Negredo", "150441100044", "20 tahun", R.drawable.foto1))
        ...
        listData.add(StringData("Erling Haaland", "210441100067", "22 tahun", R.drawable.foto2))
        ...
        listData.add(StringData("Kevin De Bruyne", "180441100007", "31 Tahun", R.drawable.foto17))
        listData.add(StringData("Sergio Kun Aguer", "160441100043", "34 tahun", R.drawable.foto18))
        listData.add(StringData("Alvaro Negredo", "150441100044", "20 tahun", R.drawable.foto19))
        listData.add(StringData("Lionel Messi", "150441100010", "34 tahun", R.drawable.foto20))
    }
